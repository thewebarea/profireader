...
$templateCache.put("src/templates/main-icons.html","<div class=\"iconset clearfix\" style=\"padding-bottom: 0;\">\n    <div class=\"col-120\" ng-repeat=\"item in fileNavigator.fileList | filter: query | orderBy: orderProp\" ng-show=\"!fileNavigator.requesting && !fileNavigator.error && item.model.type !== \'parent\'\">\n        <a href=\"\" class=\"thumbnail text-center\" ng-click=\"smartClick(item)\" ng-right-click=\"touch(item)\" title=\"{{item.model.name}} {{item.isFolder()? \'\':\'(\'+item.model.sizeKb()+\')kb\'}}\">\n            <div class=\"item-icon\">\n                <i class=\"glyphicon glyphicon-folder-open\" ng-show=\"item.model.type === \'dir\'\"></i>\n                <!--<i class=\"small-image pull-left thumbnail\" data-src=\"/static/images/0.gif\" ng-show=\"item.model.type === \'file\'\"></i>-->\n                <img class=\"img-thumbnails\" style=\"width: 32px;height: 32px\" ng-src=\"{{item.model.url}}\" ng-if=\"item.model.type === \'file\'\">\n            </div>\n            {{item.model.name | strLimit : 11 }}\n\n        </a>\n    </div>\n\n    <div ng-repeat=\"item in fileNavigator.fileList | filter: query | orderBy: orderProp\" ng-show=\"!fileNavigator.requesting && !fileNavigator.error && item.model.type === \'parent\'\">\n        <a style=\"width: inherit; padding: 39px!important;\" href=\"\" class=\"thumbnail text-center\" ng-click=\"smartClick(item)\" ng-right-click=\"touch(item)\" title=\"{{item.model.name}} {{item.isFolder()? \'\':\'(\'+item.model.sizeKb()+\')kb\'}}\">\n\n        </a>\n    </div>\n\n    <div ng-show=\"fileNavigator.requesting\">\n        <div ng-include=\"config.tplPath + \'/spinner.html\'\"></div>\n    </div>\n\n    <div class=\"alert alert-warning\" ng-show=\"!fileNavigator.requesting && fileNavigator.fileList.length === 1 && !fileNavigator.error\">\n        {{\"no_files_in_folder\" | translate}}...\n    </div>\n\n    <div ng-show=\"fileNavigator.fileList.length > 0\">\n    </div>\n    \n    <div class=\"alert alert-danger\" ng-show=\"!fileNavigator.requesting && fileNavigator.error\">\n        {{ fileNavigator.error }}\n    </div>\n</div>\n<div class=\"iconset clearfix\" style=\"padding: 0;\">\n    <div ng-repeat=\"item in fileNavigator.fileList | filter: query | orderBy: orderProp\" ng-show=\"!fileNavigator.requesting && !fileNavigator.error && item.model.type === \'parent\'\">\n        <a style=\"width: inherit; padding: 180px!important;\" href=\"\" class=\"thumbnail text-center\" ng-click=\"smartClick(item)\" ng-right-click=\"touch(item)\" title=\"{{item.model.name}} ({{item.model.sizeKb()}}kb)\">\n\n        </a>\n    </div>\n</div>\n<hr/>\n");
